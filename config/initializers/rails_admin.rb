# # RailsAdmin config file. Generated on November 07, 2012 10:52
...
#   config.main_app_name = ['Timeoverflow', 'Admin']
...
#   # config.excluded_models = ['Category', 'Organization', 'User']

#   # Include specific models (exclude the others):
#   # config.included_models = ['Category', 'Organization', 'User']
...
#   #     configure :ancestor_hierarchies, :has_many_association         # Hidden 
#   #     configure :self_and_ancestors, :has_many_association 
#   #     configure :descendant_hierarchies, :has_many_association         # Hidden 
#   #     configure :self_and_descendants, :has_many_association 
